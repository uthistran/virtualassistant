...
// stage content:
(lib.PhantarFinal = function(mode,startPosition,loop) {
	...
	this.instance_11.setTransform(490,457.7);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1).to({startPosition:0,_off:false},0).to({alpha:1},9).wait(646));

	// Bkgrnd
	this.instance_12 = new lib.Bkgrnd("synched",0);
	this.instance_12.setTransform(487.8,443.6,1.12,1.146,0,0,0,489.9,490.2);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(1).to({startPosition:0,_off:false},0).to({_off:true},645).wait(10));
